...
The experimental Julia/Flux `war1gus-ai` integration is maintained in the
[`scripts/ai/war1gus`](scripts/ai/war1gus) submodule. Its
[README](scripts/ai/war1gus/README.md) covers setup, gameplay, training,
evaluation, rewards, and logs.
